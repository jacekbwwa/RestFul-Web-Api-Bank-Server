...
public class CustomerFacadeREST extends AbstractFacade<Customer> {
    ...
    public Customer findByEmail(@PathParam("email") String email) {
        return super.findCustomerByEmail(email);
    }
    
    @GET
    @Path("TotalBalance/{id}")
    @Produces({"application/xml", "application/json"})
    public String totalBalance(@PathParam("id") Integer id)
    {        
        //return "<balance>" + String.valueOf() + "</balance>";
        return "<balance>" + String.valueOf(super.customerBalance(id)) + "</balance>";
    }    
}
